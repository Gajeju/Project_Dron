...
/*  calc_balancing_with_angle(
       roll_target_angle, pitch_target_angle, yaw_target_angle, roll_angle,
       pitch_angle, yaw_angle, roll_balancing, pitch_balancing, yaw_balancing); */
  ...
  float motorA_speed, motorB_speed, motorC_speed, motorD_speed; 
   ...
   calc_motor_speed(
        throttle, roll_balancing, pitch_balancing, yaw_balancing, motorA_speed, motorB_speed, motorC_speed, motorD_speed);
   ...
   update_motor_speed(motorA_speed, motorB_speed, motorC_speed, motorD_speed);
...
void calc_balancing_with_angle(float roll_target_angle, float pitch_target_angle,
                               float yaw_target_angle, float roll_angle,
                               float pitch_angle, float yaw_angle,
                               float &roll_balancing, float &pitch_balancing,
                               float &yaw_balancing) {
...
void  calc_motor_speed(float throttle, float roll_balancing, float pitch_balancing, float yaw_balancing,
                       float &motorA_speed, float &motorB_speed, float &motorC_speed, float &motorD_speed)
      {
     ...
     if(motorD_speed < 0) motorC_speed = 0;
     if(motorD_speed > 255) motorD_speed = 255;
      }                  

/*void print_motor_speed(float roll_angle, float pitch_angle, float yaw_angle,float roll_balancing,
                      float pitch_balancing, float yaw_balancing, float motorA_speed, float motorB_speed,
                      float motorC_speed, float motorD_speed) {
...
void update_motor_speed(float motorA_speed, float motorB_speed, float motorC_speed, float motorD_speed) {
...
void calc_balancing_with_angle_and_gyro(float roll_target_angle, float pitch_target_angle, float yaw_target_angle,
                                       float roll_angle, float pitch_angle, float yaw_angle,
                                       float roll_gyro, float pitch_gyro, float yaw_gyro,
                                       float &roll_balancing, float &pitch_balancing, float &yaw_balancing) {
